...
public class TesteAcademia {
	static int sair_cliente = 0;
	static String nome_cliente_sair = "";
	
	public void setSair(int novo_valor) {
    	TesteAcademia.sair_cliente = novo_valor;
    }
	
	public void setNomeSair(String novo_nome) {
    	TesteAcademia.nome_cliente_sair = novo_nome;
    }
	...
	public static void main(String[] args) throws IOException {
		...
		while (!("sair".equals(msg.toLowerCase()))) { 
			if(sair_cliente == 1) {
				System.out.println("[NOVA NOTIFICAÇÃO] O cliente " + nome_cliente_sair + " saiu de um dos tópicos");
				sair_cliente = 0;
			}
